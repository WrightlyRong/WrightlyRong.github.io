...
int main()
{
    ...
    char subname[currenttotalteacher][1000];
        ...
        for(i=0; i<5; i++)
        {
            ...
            for(j=0; j<3; j++)
            {
                if(i!=4)
                {
                    ...
                    if(routine[k][i][j]==0)
                        fprintf(fpprint,"\t\t%s",subname[0]);
                    else if(routine[k][i][j]==1)
                        fprintf(fpprint,"\t\t%s",subname[1]);
                    else if(routine[k][i][j]==2)
                        fprintf(fpprint,"\t\t%s",subname[2]);
                    else if(routine[k][i][j]==3)
                        fprintf(fpprint,"\t\t%s",subname[3]);
                    else if(routine[k][i][j]==4)
                        fprintf(fpprint,"\t\t%s",subname[4]);
                    else if(routine[k][i][j]==5)
                        fprintf(fpprint,"\t\t%s",subname[5]);
                    else if(routine[k][i][j]==6)
                        fprintf(fpprint,"\t\t%s",subname[6]);
                    else if(routine[k][i][j]==7)
                        fprintf(fpprint,"\t\t%s",subname[7]);
